...
Links are styled using the `$primary` color variables and include a transition that fades all elements on/off. For more about colors, see [Colors]({% post_url 2014-03-01-colors %}).
